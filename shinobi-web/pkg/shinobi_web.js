...
const ClientEngineFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_clientengine_free(ptr >>> 0, 1));
...
export class ClientEngine {
    ...
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        ClientEngineFinalization.unregister(this);
        return ptr;
    }

    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_clientengine_free(ptr, 0);
    }
    constructor() {
        const ret = wasm.clientengine_new();
        this.__wbg_ptr = ret >>> 0;
        ClientEngineFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     * @param {string} fen
    ...
    load_fen(fen) {
        try {
            ...
            wasm.clientengine_load_fen(retptr, this.__wbg_ptr, ptr0, len0);
    ...
    reset_position() {
        wasm.clientengine_reset_position(this.__wbg_ptr);
    }
    /**
     * @returns {(Move)[]}
     */
     ...
     */
    search() {
        const ret = wasm.clientengine_search(this.__wbg_ptr);
        return ret === 0 ? undefined : Move.__wrap(ret);
    }
}
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('shinobi_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
